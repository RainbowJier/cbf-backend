...
insert into sys_dept
values (101, 100, '0,100', '深圳总公司', 1, '若依', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate( ), '',
        null);
insert into sys_dept
values (102, 100, '0,100', '长沙分公司', 2, '若依', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate( ), '',
        null);
insert into sys_dept
...
VALUES ('分配角色', 100, 8, '', '', '', '', 1, 0, 'F', '0', '0', 'system:user:editRole', '#', 'admin',
        '2025-06-16 16:32:56', '', '', '');

-- 新增日志数据权限控制（2025-06-20）
ALTER TABLE sys_oper_log
    ADD user_id varchar(100) DEFAULT '' NULL COMMENT '用户id';
ALTER TABLE sys_oper_log
    ADD dept_id varchar(100) DEFAULT '' NULL COMMENT '部门id';
...
(
    ...
    ANCESTORS   VARCHAR(100) DEFAULT '0' COMMENT '祖先节点',
    FILE_TYPE   TINYINT                NOT NULL COMMENT '文件夹类型：0-单个文件，1-自定义，2-行政区划',
    PATH        VARCHAR(255)           NOT NULL COMMENT '本地存储路径',
    IS_VALID    TINYINT      DEFAULT 1 NOT NULL COMMENT '是否有效，1-有效，0-无效',
    CREATE_TIME DATETIME     DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    UPDATE_TIME DATETIME     DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间'
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4 COMMENT ='统一文件夹管理表';


/**
  文件夹-文件关联表
 */
CREATE TABLE SYS_FOLDER_REL_FILE
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='文件夹与文件关联表';
