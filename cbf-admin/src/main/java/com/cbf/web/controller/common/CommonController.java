...
import com.cbf.common.utils.file.FileUploadUtils;
import com.cbf.common.utils.file.FileUtils;
import com.cbf.framework.config.ServerConfig;
...
public class CommonController {
    ...
    public void fileDownload(String fileName, Boolean delete, HttpServletResponse response, HttpServletRequest request) {
        try {
            ...
            String filePath = CBFConfig.getDownloadPath() + fileName;
    ...
    public void resourceDownload(String resource, HttpServletResponse response) {
        try {
            ...
            // 本地资源路径
            String localPath = CBFConfig.getProfile();
            // 数据库资源地址
